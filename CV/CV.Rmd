...
scholar::get_publications("Ca8wN7sAAAAJ", flush = TRUE) %>% 
  ...
  dplyr::add_row(
   ...
   add_row(
    ...
    author = "Bolaños, L., Choi, C.J., Worden, A., Baetge, N., Carlson, C., Giovannoni, S",
    journal = "",
    number = " ",
    cites = 0,
    year = "in prep",
  ...
  add_row(
    title = "Physiological state, virus infection, and mixing dynamics contextualize phytoplankton accumulation and loss in the North Atlantic",
    author = "Diaz, B., Knowles, B., Johns, C., Laber, C., Bondoc, K.G.V, Harvey, E., Lowenstein, D., Fredricks, H., Hunter, J., Haramaty, L., Natale, F., Graff, J., Haentjens, N., Baetge, N., Mojica, K., Gaube, P., Boss, E., Carlson, C., Behrenfeld, M., Van Mooy, B., and Bidle, K",
    journal = "",
    number = " ",
    cites = 0,
    year = "in prep",
  ...
  add_row(
    ...
    author = "Liu, S., Baetge, N., Comstock, J., Opalk, K., Parsons, R., Halewood, E., English, C., Giovannoni, S., Bolanos, L., Nelson, C., Vergin, K., Carlson, C",
    journal = "Frontiers in Marine Science",
    number = " ",
    cites = 0,
    year = "in review",
  ...
  add_row(
    ...
    author = "Saliba, G., Chen, C., Lewis, S., Russell. L, Quinn, P., Bates, T., Bell, T., Lawler, M., Saltzman, E., Sanchez, K., Moore, R., Shook, M., Rivellini, L., Lee, A., Baetge, N., Carlson, C., Behrenfeld, M",
